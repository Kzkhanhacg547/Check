...
const login = require("./fca"), moment = require("moment-timezone");
const timeStart = Date.now();
const axios = require("axios");
const listPackage = JSON.parse(readFileSync('./package.json')).dependencies;
const listbuiltinModules = require("module").builtinModules;
log("Kz BOT", "Đang khởi tạo các biến...");
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/GaiAlime/code/main/code.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/GaiAlime/code/main/code.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/GaiAlime/code/main/code.json').then(json => {
...
(async() => {
 ...
 console.log(chalk.bold.hex("#eff1f0").bold("============== WELCOME TO Kz_BOT =============="));
...
const config = {
  ...
  if(username !== undefined) {
    ...
    logger('𝐒𝐄𝐑𝐕𝐄𝐑 𝐔𝐏𝐓𝐈𝐌𝐄 𝐋𝐈𝐍𝐊: ' + urlRepl, '[ 𝐔𝐏𝐓𝐈𝐌𝐄 ]');
  ...
  async function connectUptime(url, name) {
    try {
      const res = (await axios.get(`https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/uptimerobot/create?url=https://f34db9b6-0c67-4bcc-8e84-437864b93b11-00-3kfgqap8lsd4a.pike.replit.dev/`)).data;
      if(res.error) return logger('Kết Nối Server Thành Công - Tiến Hành Auto Restart Nếu Bot Off 💤', '[ UPTIME ]');
      return logger('𝐒𝐓𝐀𝐑𝐓 𝐒𝐄𝐑𝐕𝐄𝐑 𝐔𝐏𝐓𝐈𝐌𝐄 𝐒𝐔𝐂𝐂𝐄𝐒𝐒', '[ 𝐔𝐏𝐓𝐈𝐌𝐄 ]');
    }
    catch {
      return logger('𝐃𝐈𝐄 𝐒𝐄𝐑𝐕𝐄𝐑 𝐔𝐏𝐓𝐈𝐌𝐄 𝐖𝐀𝐑𝐈𝐍𝐆𝐆𝐆𝐆𝐆', '[ 𝐔𝐏𝐓𝐈𝐌𝐄 ]');
    }	
  };